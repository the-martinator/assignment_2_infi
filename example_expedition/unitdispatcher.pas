...
begin
  ...
  production_order.order_type  := Type_Expedition ;  //Expedition
  production_order.part_numbers:= 2;
  production_order.part_type:= 8;                    //Green Lids
...
begin
  ...
  r := M_Initialize(1, 4);
  sleep(1500);
  r := r + M_Initialize(10, 4);
  sleep(1500);
  r := r + M_Initialize(19, 8);
  sleep(1500);
  r := r + M_Initialize(28, 8);
  ...
  SetLength(WAREHOUSE_Parts, 54);                //Parts in the warehouse
  for  cel := 0 to  Length(WAREHOUSE_Parts)-1 do
  begin
      WAREHOUSE_Parts[cel] := 0;
  end;
  WAREHOUSE_Parts[0]  := 4;
  WAREHOUSE_Parts[9]  := 4;
  WAREHOUSE_Parts[18] := 8;
  WAREHOUSE_Parts[27] := 8;


  //Converts ProductionOrders to Tasks
...
begin
  ...
  begin
     case current_operation of
        ...
        // Request the unload of that part
        EXP_Unload :
        begin
